...
jQuery(document).ready(function ($) {
    ...
    $(".panel-dialog select.calendar-widget-add-filter").select2(select2Opts);


    $(document).on('panelssetup', function () {
        //
        // Fix for Event Calendar Pro
        //
        if ($(".panel-dialog select.calendar-widget-add-filter").length > 0) {
            var $body = $('body'),
                select2Opts = {};
    ...
    $body.on('change', 'select.calendar-widget-add-filter', function (e) {
        ...
        var wrapper = select.parents('.panel-dialog');
    ...
    $body.on('click', '.calendar-widget-remove-filter', function (e) {
        ...
        var wrapper = object.parents('.panel-dialog');
        var hidden = wrapper.find('.calendar-widget-added-filters');
