...
class SiteOrigin_Panels_Widget_Animated_Image extends SiteOrigin_Panels_Widget  {
	...
	function enqueue_scripts(){
		...
		if(!$enqueued) {
			wp_enqueue_script('siteorigin-widgets-'.$this->origin_id.'-onscreen', plugin_dir_url(__FILE__).'js/onscreen.js', array('jquery'), PP_PAGE_BUILDER_VERSION);
			wp_enqueue_script('siteorigin-widgets-'.$this->origin_id, plugin_dir_url(__FILE__).'js/main.js', array('jquery'), PP_PAGE_BUILDER_VERSION);
			$enqueued = true;
		}
