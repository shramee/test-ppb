<?php
/*
Plugin Name: Pootle Visual Editor 2
Description: Adds a new "Visual Editor" widget type based on the native WordPress TinyMCE editor. Based on Black Studio Visual Editor 2.2.1
Version: 2.0
Author: PootlePress
...
if ( ! class_exists( 'Black_Studio_TinyMCE_Plugin' ) ) {
	...
	final class Black_Studio_TinyMCE_Plugin {
		...
		public function widgets_init() {
			...
			register_widget( 'Pootle_Visual_Editor_2' );
		}
		...
		public function check_widget( $widget ) {
			return gettype( $widget ) == 'object' && get_class( $widget ) == 'Pootle_Visual_Editor_2';
		}
