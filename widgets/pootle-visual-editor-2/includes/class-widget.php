...
if ( ! class_exists( 'Pootle_PB_Content_Block' ) ) {
	...
	class Pootle_PB_Content_Block extends WP_Widget {
		...
		public function __construct() {
			...
			$widget_ops         = array( 'classname'   => 'widget_black_studio_tinymce',
		...
		public function form( $instance ) {
			...
			<input id="<?php echo $this->get_field_id( 'type' ); ?>"
			       name="<?php echo $this->get_field_name( 'type' ); ?>" type="hidden"
			...
			?>
			<input id="<?php echo $this->get_field_id( 'filter' ); ?>-hidden"
			       name="<?php echo $this->get_field_name( 'filter' ); ?>" type="hidden" value="0"/>
			<p><input id="<?php echo $this->get_field_id( 'filter' ); ?>"
			          name="<?php echo $this->get_field_name( 'filter' ); ?>" type="checkbox"
			          value="1" <?php checked( $instance['filter'] ); ?> />&nbsp;<label
