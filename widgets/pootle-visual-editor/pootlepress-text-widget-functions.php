...
if (!function_exists('pootlepress_text_widgets_init')) {
...
if (!function_exists('pootlepress_text_widget_admin_init')) {
...
if (!function_exists('pootle_text_widget_load_tiny_mce')) {
...
if (!function_exists('pootle_text_widget_init_editor')) {
...
/* Widget js loading */
if (!function_exists('pootle_text_widget_scripts')) {
...
/* Widget css loading */
if (!function_exists('pootle_text_widget_styles')) {
...
/* Footer script */
if (!function_exists('pootle_text_widget_footer_scripts')) {
...
if (!function_exists('pootle_text_widget_apply_smilies_to_widget_text')) {
...
if (!function_exists('pootle_text_widget_upload_iframe_src')) {
...
if (!function_exists('pootle_text_widget_editor_accessibility_mode')) {
...
if (!function_exists('pootle_text_widget_init_woo_shortcode')) {
