    ...
    $('.jp-jplayer').each(function () {
        ...
        $$.jPlayer({
            ready: function () {
                ...
                $(this).jPlayer("setMedia", {m4v: $(this).attr('data-video'), poster: $(this).attr('data-poster')});
            ...
            autohide: {restored: false, full: false},
            play: function () {
                $(this).jPlayer("pauseOthers");
                $(this).jPlayer('option', 'autohide', {restored: true, full: true, hold: 2000});
            },
            size: {width: "100%", height: Math.floor($$.closest('.widget').outerWidth() / ratio)},
